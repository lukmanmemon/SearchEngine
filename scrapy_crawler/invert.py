...
def invert(testMode=False, testFilePath=""):
    ...
    for content in content_list:
        for word in content:
            ...
            if stripped_word.isalpha() and stripped_word not in stopwords_list:
    ...
    write_file_dict = codecs.open(testFilePath + "dict.txt","w", encoding='utf-8')
    ...
    for content in content_list:
        for line in content:
            ...
            for word in word_tokenize(line):
                ...
                if term.isalpha() and term not in stopwords_list:
